...
const quizQuestions = [
  {
    "question": "What was stolen from the National Museum of Natural History in Paris?",
    "type": "single-choice",
    "answer": [
      "Native gold"
    ],
    "explanation": "The article clearly states that the thieves stole native gold from the museum.",
    "options": [
      "Jewelry gold",
      "Diamonds",
      "Chinese porcelain",
  ...
  {
    "question": "When did the theft at the National Museum of Natural History occur?",
    "type": "single-choice",
    "answer": [
      "September 16, 2025"
    ],
    "explanation": "The article mentions that the theft happened on September 16, 2025.",
    "options": [
      "September 1, 2025",
      "October 2, 2025",
      "Late 2024",
  ...
  {
    "question": "What tools did the thieves use to open the glass display cases?",
    "type": "multiple-choice",
    "answer": [
      "Blowtorch",
      "Angle grinder"
    ],
    "explanation": "The article states that the thieves used a blowtorch and an angle grinder to open the display cases.",
    "options": [
      "Axe",
      "Screwdriver",
      "Blowtorch",
  ...
  {
    "question": "What makes native gold different from jewelry gold?",
    "type": "single-choice",
    "answer": [
      "It is found naturally in the Earth"
    ],
    "explanation": "The article explicitly states that native gold is found naturally in the Earth, while jewelry gold needs to be processed.",
    "options": [
      "It is more valuable",
  ...
  {
    "question": "According to the museum director, what indicated that the thieves were professionals?",
    "type": "multiple-choice",
    "answer": [
      "They knew exactly what to take",
      "They had the right tools"
    ],
    "explanation": "Emmanuel Skoulios stated that the thieves' knowledge of what to take and their possession of the right tools suggested professional involvement.",
    "options": [
      "They wore disguises",
      "They knew exactly what to take",
      "They were very fast",
  ...
  {
    "question": "What was the approximate value of the stolen native gold?",
    "type": "single-choice",
    "answer": [
      "$700,000"
    ],
    "explanation": "The article mentions that the stolen native gold was worth about $700,000.",
    "options": [
      "$9.5 million",
      "$1 million",
      "$500,000",
  ...
  {
    "question": "Besides the National Museum of Natural History, where else in France did a theft occur in early September 2025?",
    "type": "single-choice",
    "answer": [
      "A museum in Limoges"
    ],
    "explanation": "The article mentions that in early September, three Chinese porcelain treasures were stolen from a museum in Limoges.",
    "options": [
  ...
  {
    "question": "What did thieves steal from the Musée Cognacq-Jay in late 2024?",
    "type": "multiple-choice",
    "answer": [
      "18th-century luxury items",
      "A diamond-covered box"
    ],
    "explanation": "The article states that thieves stole 18th-century luxury items, including a diamond-covered box, from the Musée Cognacq-Jay.",
    "options": [
      "Native gold",
      "18th-century luxury items",
      "A diamond-covered box",
  ...
  {
    "question": "As of October 2, 2025, had anyone been caught for the museum thefts in France?",
    "type": "single-choice",
    "answer": [
      "No"
    ],
    "explanation": "The article explicitly states that as of October 2, 2025, no one had been caught for any of the mentioned crimes.",
    "options": [
      "Yes",
      "No",
...
const articleContent = "# **Thieves Steal Gold From Paris Museum**\n\nOn September 16, 2025, in the early morning, thieves broke into the National Museum of Natural History in Paris, France. They stole native gold worth about $700,000 from the geology and mineral gallery.\n\nNative gold is very rare. It is different from the gold used in jewelry. Jewelry gold comes from gold ore and needs to be cleaned and processed. But native gold is found naturally in the Earth. Each piece is special with its own shape and crystals. Scientists study it to learn about Earth’s history.\n\nThe museum says the thieves had a careful plan. They turned off the alarm and security system, so no one noticed them. Then they used a blowtorch and an angle grinder (a cutting tool) to open the glass display cases.\n\nThe museum director, Emmanuel Skoulios, said, “This was done by professionals. They knew exactly what to take and had the right tools.” After the theft, the gallery was closed to the public. The museum also added more security to stop future robberies.\n\nThis is not the only theft in France. In early September, three Chinese porcelain treasures were stolen from a museum in Limoges. They were worth about $9.5 million.\n\nIn late 2024, another group of thieves used axes to break glass cases at the Musée Cognacq-Jay in Paris. They stole 18th-century luxury items, including a diamond-covered box. As of October 2, 2025, no one has been caught for any of these crimes.";
