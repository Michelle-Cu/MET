...
const quizQuestions = [
  {
    ...
    "explanation": "The article states that the Purdue University robot solved the Rubik's Cube in 0.103 seconds.",
    "question": "How quickly did the Purdue University robot solve the Rubik's Cube?",
    "type": "single-choice",
    "options": [
      "0.305 seconds",
      "0.103 seconds",
  ...
  },
  {
    ...
    "explanation": "The article states that the old record was set by engineers in Japan.",
    "question": "Which country's engineers previously held the world record for the fastest Rubik's Cube solving robot?",
    "type": "single-choice",
    "options": [
      "USA",
      "Japan",
  ...
  },
  {
    ...
    "explanation": "The article mentions the robot uses strong motors, a special 3D-printed case, smart software, and high-speed cameras to achieve its speed.",
    "question": "Which of the following contributed to the Purdue robot's fast solving time? Select all that apply.",
  ...
  },
  {
    ...
    "explanation": "The article says the robot uses two high-speed cameras that scan the cube’s colors in just 10 microseconds.",
    "question": "How quickly can the Purdue robot's cameras scan the colors of the Rubik's Cube?",
    "type": "single-choice",
    "options": [
      "1 second",
      "1 millisecond",
  ...
  },
  {
    ...
    "explanation": "The article states that the robot was first built for a school competition called the Spark Challenge.",
    "question": "The robot was first built for a school competition called the __BLANK__.",
    "type": "cloze"
  },
  {
    "answer": [
    ...
    "explanation": "Matthew Patrohay was inspired by a video he saw in high school, where MIT students solved the cube in 380 milliseconds.",
    "question": "Who inspired Matthew Patrohay to build the Rubik's Cube solving robot?",
    "type": "single-choice",
    "options": [
      "Engineers in Japan",
      "MIT students",
  ...
  },
  {
    ...
    "explanation": "The article mentions Matthew Patrohay as the leader of the student team that built the robot.",
    "question": "Who led the student team that built the 'Purdubik's Cube'?",
    "type": "single-choice",
    "options": [
      "Elon Musk",
      "Bill Gates",
  ...
  {
    "answer": [
      "Doesn’t break when moving quickly"
    ],
    "explanation": "The article states that the cube is made stronger, so it doesn’t break when moving quickly.",
    "question": "Why is the Rubik's Cube used by the robot made stronger?",
    "type": "single-choice",
    "options": [
      "Looks better",
      "Is easier to scan",
  ...
  {
    "answer": [
      "Reads only the color data"
    ],
    "explanation": "Instead of looking at full pictures, it reads only the color data. This helps it solve the cube even faster.",
    "question": "How does the robot's software process the image data from the cameras to speed up the solving process?",
    "type": "single-choice",
    "options": [
      "Looks at full pictures",
      "Reads only the color data",
      "Ignores the image data",
      "Sends data to a human operator"
    ]
  }
];
const articleContent = "# Purdue University Robot Breaks Rubik’s Cube World Record\n\nA robot made by college students at Purdue University in Indiana has solved a Rubik’s Cube in just 0.103 seconds — that’s about twice as fast as a human blink! The robot is called “Purdubik’s Cube”, and it broke the Guinness World Record for the fastest robot to solve a rotating puzzle cube on April 21, 2025.\n\nThe old record was set in 2024 by engineers in Japan. Their robot solved the cube in 0.305 seconds.\n\nSo how did the Purdue robot go so fast? First, it uses strong motors and a special 3D-printed case to hold the cube. The cube is also made stronger, so it doesn’t break when moving quickly.\n\nSecond, the robot uses smart software. It has two high-speed cameras that scan the cube’s colors in just 10 microseconds. Instead of looking at full pictures, it reads only the color data. This helps it solve the cube even faster, by turning more than one side at the same time.\n\nThe robot was first built in December 2024 by a student team for a school competition called the Spark Challenge. Their leader, Matthew Patrohay, said he was inspired by a video he saw in high school, where MIT students solved the cube in 380 milliseconds.\n\n“I thought, ‘That’s really cool. I want to beat that someday,’” he said. “Now I’m here at Purdue — and we went even faster!”";
