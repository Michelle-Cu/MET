...
const quizQuestions = [
  {
    ...
    "explanation": "The first images released are from the Vera C. Rubin Observatory, as stated in the first sentence of the article.",
    "question": "The first images released are from which observatory?",
    "type": "single-choice",
    "options": [
      "Keck Observatory",
      "Vera C. Rubin Observatory",
  ...
  },
  {
    ...
    "explanation": "The Rubin Observatory sits atop Cerro Pachón, a mountain in northern Chile.",
    "question": "The Rubin Observatory is located in:",
    "type": "single-choice",
    "options": [
      "northern Chile",
      "southern Argentina",
  ...
  },
  {
    ...
    "explanation": "The observatory has the world’s largest digital camera.",
    "question": "The Rubin Observatory has the world's:",
    "type": "single-choice",
    "options": [
      "largest telescope",
      "most powerful radar",
      "largest digital camera",
      "most advanced spectroscope"
    ]
  },
  {
    "answer": [
    ...
    "explanation": "The article states that the observatory will help scientists find new asteroids, watch exploding stars, and learn more about dark matter and dark energy.",
    "question": "For the next ten years, the observatory will help scientists learn more about which of the following?",
  ...
  },
  {
    ...
    "explanation": "Cerro Pachón is known for its clear, dark skies, making it an ideal location for the observatory.",
    "question": "Cerro Pachón, where the Rubin Observatory is located, is known for its:",
    "type": "single-choice",
    "options": [
