...
const quizQuestions = [
  {
    ...
    "explanation": "The article states, 'On July 8, 2025, a new doll joined the collection — a Barbie with Type 1 diabetes (T1D).'",
    "question": "When was the Barbie with Type 1 diabetes released?",
    "type": "single-choice",
    "options": [
      "July 8, 2025",
      "June 8, 2024",
  ...
  },
  {
    ...
    "explanation": "The article mentions the doll wears a blue polka dot outfit, inspired by the blue circle, the symbol for diabetes awareness.",
    "question": "The new Barbie's outfit is inspired by the symbol for what?",
    "type": "single-choice",
    "options": [
      "childhood cancer",
      "diabetes awareness",
  ...
  },
  {
    ...
    "explanation": "The article mentions 'On her arm is a glucose monitor... At her waist is a small insulin pump...'",
    "question": "According to the article, which of the following medical devices are included with the new Barbie doll? (Select all that apply)",
  ...
  },
  {
    ...
    "explanation": "The article quotes Krista Berger, Senior Vice President of Barbie, regarding the doll's inclusivity.",
    "question": "Who is quoted in the article stating that the new Barbie is an important step in their commitment to inclusivity?",
    "type": "single-choice",
    "options": [
      "Lila Moss",
      "Robin Arzón",
  ...
  },
  {
    ...
    "explanation": "The article states 'Mattel also honored two women with their own special Barbie dolls: Robin Arzón, a Peloton instructor, and Lila Moss, a fashion model.'",
    "question": "Which of the following professions are held by the women honored with their own Barbie dolls?",
    "type": "multiple-choice",
    "options": [
      "Doctor",
      "Peloton instructor",
  ...
  },
  {
    ...
    "explanation": "The article mentions 'Since 2009, Mattel has made dolls with different body types, skin colors, and even medical conditions.'",
    "question": "Since what year has Mattel been creating dolls with diverse features, including different body types and medical conditions?",
    "type": "single-choice",
    "options": [
      "1999",
      "2009",
  ...
  },
  {
    ...
    "explanation": "The article states 'She also has a smartphone with a glucose tracking app.' and 'She carries a pastel blue bag that could hold snacks or diabetes supplies.'",
    "question": "According to the article, what items are included with the new Barbie doll? (Select all that apply)",
    "type": "multiple-choice",
    "options": [
      "stethoscope",
      "glucose tracking app",
  ...
  },
  {
    ...
    "explanation": "The first sentence states 'Barbie’s *Fashionistas* line is all about diversity and self-expression.'",
    "question": "The Barbie with Type 1 Diabetes belongs to which Barbie doll line?",
    "type": "single-choice",
    "options": [
      "Dreamhouse",
      "Fashionistas",
...
const articleContent = "# Barbie Releases New Doll with Type 1 Diabetes\n\nBarbie’s *Fashionistas* line is all about diversity and self-expression. Since 2009, Mattel has made dolls with different body types, skin colors, and even medical conditions. There are dolls who are blind, have Down syndrome, use a wheelchair, or wear hearing aids. On July 8, 2025, a new doll joined the collection — a Barbie with Type 1 diabetes (T1D).\n\nThe new doll is both stylish and meaningful. She wears a blue polka dot outfit, inspired by the blue circle, the symbol for diabetes awareness. She carries a pastel blue bag that could hold snacks or diabetes supplies. On her arm is a glucose monitor, with pink, heart-shaped medical tape. At her waist is a small insulin pump that delivers insulin, just like many people with T1D use every day. She also has a smartphone with a glucose tracking app.\n\n“Introducing a Barbie doll with type 1 diabetes is an important step in our commitment to inclusivity,” said Krista Berger, Senior Vice President of Barbie. “Barbie helps shape how children see the world, and now more kids can see themselves in the dolls they play with.”\n\nMattel also honored two women with their own special Barbie dolls: Robin Arzón, a Peloton instructor, and Lila Moss, a fashion model. Both live with T1D and use their platforms to raise awareness. Moss even walked the runway while wearing her insulin pump. “I hope this doll inspires people with T1D to wear their pump proudly,” Moss said.";
